<?php $__env->startSection('title', 'Mon Profil - Étudiant'); ?>
    ...
    <div class="mx-auto">
        ...
        <div class="mb-6">
            <div class="flex justify-between text-sm mb-1">
                ...
                <span class="text-indigo-600 font-medium"><?php echo e($completion); ?>%</span>
            </div>
                ...
                <div class="bg-white rounded-xl shadow-sm p-6 text-center">
                    <div class="flex flex-col items-center">
                        <div class="h-24 w-24 rounded-full bg-indigo-100 flex items-center justify-center overflow-hidden shadow-lg mb-3">
                            <?php if($user->avatar_path && file_exists(public_path($user->avatar_path))): ?>
                                <img src="<?php echo e(asset($user->avatar_path)); ?>" alt="Avatar" class="h-full w-full object-cover">
                            <?php else: ?>
                                <span class="text-indigo-600 font-bold text-4xl"><?php echo e(substr($user->name, 0, 1)); ?></span>
                            <?php endif; ?>
                        </div>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="bg-white rounded-xl shadow-sm p-6">
                    ...
                    <div class="grid md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <select name="search_type" class="w-full px-4 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                                ...
                                <option value="stage" <?php echo e($user->search_type == 'stage' ? 'selected' : ''); ?>>Stage</option>
                                <option value="alternance" <?php echo e($user->search_type == 'alternance' ? 'selected' : ''); ?>>Alternance</option>
                                <option value="premier_emploi" <?php echo e($user->search_type == 'premier_emploi' ? 'selected' : ''); ?>>Premier emploi</option>
                                <option value="cdi" <?php echo e($user->search_type == 'cdi' ? 'selected' : ''); ?>>CDI</option>
                                <option value="cdd" <?php echo e($user->search_type == 'cdd' ? 'selected' : ''); ?>>CDD</option>
                                <option value="interim" <?php echo e($user->search_type == 'interim' ? 'selected' : ''); ?>>Intérim</option>
                            </select>
                        </div>

                        <div>
                            <label class="block text-sm font-medium text-slate-700 mb-1">Date de disponibilité</label>
                            <input type="date" name="availability_date" value="<?php echo e(old('availability_date', $user->availability_date)); ?>"
                                class="w-full px-4 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                        </div>
                    </div>
                    ...
                    <div class="mt-4 flex flex-col gap-3">
                        <label class="inline-flex items-center cursor-pointer">
                            ...
                            <input type="checkbox" name="is_available" value="1" <?php echo e($user->is_available ? 'checked' : ''); ?>
                        ...
                        <label class="inline-flex items-center cursor-pointer">
                            ...
                            <input type="checkbox" name="driving_license" value="1" <?php echo e($user->driving_license ? 'checked' : ''); ?>
                ...
                <div class="bg-white rounded-xl shadow-sm p-6">
                    ...
                    <?php if($user->cv_path && file_exists(public_path($user->cv_path))): ?>
                        <div class="flex items-center justify-between bg-slate-50 p-4 rounded-lg mb-4">
                            ...
                            <a href="<?php echo e(asset($user->cv_path)); ?>" target="_blank" class="text-indigo-600 hover:text-indigo-700 text-sm">
                    ...
                    <label class="block">
                        <span class="cursor-pointer bg-slate-100 hover:bg-slate-200 text-slate-700 px-4 py-2 rounded-lg font-medium transition inline-flex items-center gap-2">
                            ...
                            <?php echo e($user->cv_path ? 'Changer le CV' : 'Uploader un CV'); ?>
                        ...
                        <?php $__currentLoopData = $allSkills; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $skill): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <label class="skill-checkbox cursor-pointer" onclick="toggleSkill(this)">
                                <input type="checkbox" name="skills[]" value="<?php echo e($skill->id); ?>" 
                                    <?php echo e(in_array($skill->id, $userSkills) ? 'checked' : ''); ?>

                                    class="hidden">
                                <span class="px-3 py-1.5 rounded-full text-sm font-medium transition-all duration-200 inline-block
                                    <?php echo e(in_array($skill->id, $userSkills) ? 'bg-indigo-600 text-white' : 'bg-slate-100 text-slate-600 hover:bg-slate-200'); ?>">
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/mathis/Documents/Informatique/AUTRES/PHP/Laravel/SmartIntern/resources/views/profile/student.blade.php ENDPATH**/ ?>