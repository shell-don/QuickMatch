    ...
    <div class="max-w-7xl mx-auto px-4">
        <div class="grid lg:grid-cols-2 gap-8 items-center">
            ...
            <div class="bg-white rounded-xl p-4 shadow-lg">
                <form action="<?php echo e(route('companies.index')); ?>" method="GET" class="flex gap-3">
                    <input 
                        type="text" 
                        name="search" 
            ...
            <div class="bg-white rounded-xl shadow-sm hover:shadow-md transition overflow-hidden">
                <div class="p-5">
                    <div class="flex items-center mb-3">
                        ...
                        <div>
                            <h3 class="font-semibold text-slate-800"><?php echo e($company->name); ?></h3>
                            <?php if($company->industry): ?>
                                <p class="text-slate-500 text-sm"><?php echo e($company->industry); ?></p>
                            <?php endif; ?>
                        </div>
                    </div>
                    ...
                    <div class="space-y-1 text-slate-500 text-sm mb-4">
                        <?php if($company->size): ?>
                            <p><i class="bi bi-people mr-1"></i><?php echo e($company->size); ?></p>
                        <?php endif; ?>
                        <?php if($company->region): ?>
                            <p><i class="bi bi-geo-alt mr-1"></i><?php echo e($company->region->name); ?></p>
                        <?php endif; ?>
                    </div>
                    
                    <a href="<?php echo e(route('companies.show', $company)); ?>" class="block w-full text-center py-2 border border-indigo-600 text-indigo-600 rounded-lg hover:bg-indigo-600 hover:text-white transition">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/mathis/Documents/Informatique/AUTRES/PHP/Laravel/SmartIntern/resources/views/companies/index.blade.php ENDPATH**/ ?>