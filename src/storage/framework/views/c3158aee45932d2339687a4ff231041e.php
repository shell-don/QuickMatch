<?php $__env->startSection('title', 'SmartIntern - Trouvez votre stage idéal'); ?>
        ...
        <div class="grid lg:grid-cols-2 gap-12 items-center w-full max-w-5xl">
            ...
            <div class="text-center lg:text-left order-2 lg:order-1">
                ...
                <div class="flex flex-wrap gap-4 justify-center lg:justify-start mb-12">
                    <a href="<?php echo e(route('register')); ?>" class="bg-indigo-600 hover:bg-indigo-700 text-white px-6 py-3 rounded-lg font-medium transition flex items-center gap-2">
                        <i class="bi bi-rocket-takeoff"></i> Commencer maintenant
                    </a>
                    <a href="<?php echo e(route('offers.index')); ?>" class="border border-slate-600 text-white px-6 py-3 rounded-lg font-medium hover:bg-white/10 transition flex items-center gap-2">
                ...
                <div class="flex justify-center lg:justify-start gap-8">
                    <div class="text-center">
                        <span class="block text-3xl font-bold text-indigo-400"><?php echo e(\App\Models\Offer::count()); ?></span>
                        <span class="text-slate-500 text-sm">Offres</span>
                    </div>
                    <div class="text-center">
                        <span class="block text-3xl font-bold text-indigo-400"><?php echo e(\App\Models\Company::count()); ?></span>
                        <span class="text-slate-500 text-sm">Entreprises</span>
                    </div>
                    <div class="text-center">
                        <span class="block text-3xl font-bold text-indigo-400"><?php echo e(\App\Models\Formation::count()); ?></span>
            ...
            <div class="flex flex-col items-center order-1 lg:order-2">
                ...
                <div class="w-full max-w-sm bg-white rounded-2xl shadow-2xl overflow-hidden">
                    ...
                    <div class="p-5 text-center">
                        <h3 class="text-xl font-bold text-slate-800 mb-1"><?php echo e($randomFormation->title); ?></h3>
                        <p class="text-slate-500 text-sm mb-3">
                            <i class="bi bi-building mr-1"></i><?php echo e($randomFormation->school); ?> • <?php echo e($randomFormation->city); ?>

                        </p>
                        <div class="flex flex-wrap justify-center gap-2 mb-3">
                            <?php if($randomFormation->level): ?>
                                <span class="bg-slate-100 text-slate-700 px-3 py-1 rounded-full text-xs font-medium"><?php echo e($randomFormation->level); ?></span>
                            <?php endif; ?>
                            <?php if($randomFormation->duration): ?>
                                <span class="bg-slate-100 text-slate-700 px-3 py-1 rounded-full text-xs font-medium"><?php echo e($randomFormation->duration); ?></span>
                            <?php endif; ?>
                            <span class="px-3 py-1 rounded-full text-xs font-medium <?php echo e($randomFormation->type == 'alternance' ? 'bg-green-100 text-green-700' : 'bg-indigo-100 text-indigo-700'); ?>">
                                <?php echo e($randomFormation->type == 'alternance' ? 'Alternance' : 'Formation'); ?>

                            </span>
                        </div>
                        <div class="flex flex-wrap justify-center gap-1 mb-4">
                            <?php $__currentLoopData = $randomFormation->skills->take(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $skill): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <span class="px-2 py-1 bg-slate-50 text-slate-600 rounded text-xs"><?php echo e($skill->name); ?></span>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                        <a href="<?php echo e(route('formations.show', $randomFormation)); ?>" class="inline-block w-full py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 transition">
                            Voir la formation
                        </a>
                    </div>
                </div>
...
<section class="py-16 bg-slate-50">
    <div class="max-w-7xl mx-auto px-4">
        ...
        <div class="grid md:grid-cols-3 gap-6">
            ...
            ?>
            <?php $__empty_1 = true; $__currentLoopData = $latestOffers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $offer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="bg-white rounded-xl shadow-sm hover:shadow-md transition overflow-hidden">
                    <div class="p-5">
                        <span class="inline-block px-3 py-1 rounded-full text-xs font-medium mb-3 <?php echo e($offer->type == 'alternance' ? 'bg-green-100 text-green-700' : 'bg-indigo-100 text-indigo-700'); ?>">
                            <?php echo e(ucfirst($offer->type)); ?>

                        </span>
                        <h3 class="font-semibold text-lg mb-2 line-clamp-1"><?php echo e($offer->title); ?></h3>
                        <p class="text-slate-500 text-sm mb-1">
                            <i class="bi bi-building mr-1"></i><?php echo e($offer->company?->name); ?>

                        </p>
                        <p class="text-slate-500 text-sm mb-4">
                            <i class="bi bi-geo-alt mr-1"></i><?php echo e($offer->region?->name ?? 'France'); ?>
        ...
        <div class="text-center mt-8">
            <a href="<?php echo e(route('offers.index')); ?>" class="inline-block bg-indigo-600 hover:bg-indigo-700 text-white px-6 py-3 rounded-lg transition">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/mathis/Documents/Informatique/AUTRES/PHP/Laravel/SmartIntern/resources/views/welcome.blade.php ENDPATH**/ ?>